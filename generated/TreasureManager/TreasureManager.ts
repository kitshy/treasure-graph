...
export class TreasureManager extends ethereum.SmartContract {
  ...
  granterRewardAmount(param0: Address, param1: Address): BigInt {
    let result = super.call(
      "granterRewardAmount",
      "granterRewardAmount(address,address):(uint256)",
  ...
  queryReward(tokenAddress: Address): BigInt {
  ...
  try_queryReward(tokenAddress: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "queryReward",
...
export class ClaimAllTokenCall extends ethereum.Call {
  get inputs(): ClaimAllTokenCall__Inputs {
    return new ClaimAllTokenCall__Inputs(this);
  }

  get outputs(): ClaimAllTokenCall__Outputs {
    return new ClaimAllTokenCall__Outputs(this);
  }
}

export class ClaimAllTokenCall__Inputs {
  _call: ClaimAllTokenCall;

  constructor(call: ClaimAllTokenCall) {
    this._call = call;
  }
}

export class ClaimAllTokenCall__Outputs {
  _call: ClaimAllTokenCall;
